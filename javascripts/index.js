...
if (FULLSCREEN == true) {
  ...
  document.getElementById("_canvas_container").innerHTML =
    '<h2>JEWELLERY TRY ON</h2><div style="border-bottom: 1px solid #f0f0f0;">&nbsp;</div><br/>&nbsp;<br/><canvas id="_imageData"></canvas>';
}
...
function processLandmarksCallback(ctx, array, color, radius) {
  // let neck_points = [];
  const neck_left_point = array[3];
  const neck_right_point = array[13];
  const nose_point = array[30];
  const nosepin_point = array[34];
  ...
  // for (let pt = 3, pt<= 13, pt++){
  //   neck_points.push(array[pt])
  //   // console.lo
  // }
  // console.log("neck points",neck_points)
  ...
  if (VERBOSE == true) {
    ...
    // ctx.beginPath();
    // ctx.arc(
    //   point_above_nose_point.x,
    //   point_above_nose_point.y,
    //   _radius,
    //   0,
    //   2 * Math.PI,
    // );
  ...
  if (VERBOSE == true) {
    ...
    ctx.fillText(
      "T-Ear : " +
        THRESHOLD_FOR_EARING_DETECTION +
        "%,\t\t\t\tC-Value: " +
    ...
    ctx.fillText(
      "ED:TW : " + ((distanceBetweenEars / _width) * 100).toFixed(2),
      5,
      50,
    );
  }
  ...
  if (IMAGE_TYPE == "EARRING") {
    ...
    if (
      ...
      if (slope >= 0) {
        ...
        ctx.drawImage(
          JewelleryToTry,
          nosepin_point.x - (JEWELLERY_SIZE * 100) / 2 + OffsetToPlotEar.x,
          nosepin_point.y + OffsetToPlotEar.y - 25,
          JEWELLERY_SIZE * 100,
          JEWELLERY_SIZE * 100,
        );
      } else {
        ...
        // for (let ptr = 0, ptr<neck_points.length, ptr++){
        // ctx.drawImage(
        //   JewelleryToTry,
        //   neck_points[ptr].x - (JEWELLERY_SIZE * 100) / 2 + OffsetToPlotEar.x,
        //   neck_points[ptr].y + OffsetToPlotEar.y +50,
        //   JEWELLERY_SIZE * 100,
        //   JEWELLERY_SIZE * 100,
        // );
        // }
        ...
        //     OffsetToPlotEar.x -
        //     10,
        //   neck_left_point.y + OffsetToPlotEar.y + 120,
        //   JEWELLERY_SIZE * 100,
        //   JEWELLERY_SIZE * 100,
        // );
        // ctx.drawImage(
        ...
        //     OffsetToPlotEar.x +
        //     10,
        //   neck_right_point.y + OffsetToPlotEar.y + 120,
        //   JEWELLERY_SIZE * 100,
        //   JEWELLERY_SIZE * 100,
        // );
      }
